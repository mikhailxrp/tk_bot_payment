...
Монорепо: Telegram-бот платной подписки на закрытую группу (Робокасса, mute вместо kick,
напоминания) + веб-админ-панель на Next.js (управление, статистика, аналитика).
Источник истины по требованиям — `prd.md`.
